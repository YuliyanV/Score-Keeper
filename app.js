...
function reset() {
    ...
    p1Display.classList.remove('winner', 'loser'); // Remove Color After Reset for Player One
    p2Display.classList.remove('winner', 'loser'); // Remove Color After Reset for Player Two
